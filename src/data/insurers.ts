...
export const INSURERS: InsurerData[] = [
  ...
  },
  {
    ...
    cons: [
      "Pas le moins cher sur les profils jeunes standard (April est souvent un peu moins cher)",
