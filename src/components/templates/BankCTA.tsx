    ...
    <section className="bg-primary-900 py-16">
      <div className="max-w-6xl mx-auto px-4 md:px-6 lg:px-8 text-center">
        <h2 className="text-2xl md:text-3xl font-bold text-white mb-4">
          Pr&ecirc;t &agrave; quitter l&apos;assurance {bank.insurerName} de {bank.name}&nbsp;?
        </h2>
        <p className="text-primary-100 text-base md:text-lg mb-8 max-w-2xl mx-auto leading-relaxed">
          Simulez votre &eacute;conomie et recevez votre lettre de changement en 2&nbsp;minutes.
        </p>
        <a
          href="#simulateur"
        ...
        >
          Calculer mon &eacute;conomie &rarr;
        </a>
      </div>
    </section>
  );
